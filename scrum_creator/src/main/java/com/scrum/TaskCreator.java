...
public class TaskCreator {
    ...
    public Task parseTask(String jsonData) {
        ...
        try {
            ...
            String finalDateString = generateDate(initialDateString);

            LocalDate initialDate=transformDate(initialDateString);
            LocalDate finalDate=transformDate(finalDateString);
    ...
    public void addTask(Task task) {
        try {
            URL url = new URL("http://localhost:8080/backEnd/rest/users/addTask");
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
